...
public class LoginJdbc{
	...
	public static String klogin(String mail,String pass){
		...
		try{
			...
			//select文
			String sql="SELECT user_id FROM userTable WHERE user_admin = 1 AND user_mail = '"+mail+"' AND user_pass = '"+pass+"'";
	...
	public static String mlogin(String mail,String pass){
